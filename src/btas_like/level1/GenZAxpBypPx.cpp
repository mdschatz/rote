...
template <typename T>
bool CheckZAxpPxArgs(const DistTensor<T> &X, const DistTensor<T> &Y,
...
template <typename T>
void GenZAxpBypPx(T alpha, const DistTensor<T> &X, T beta,
...
#define PROTO(T)                                                               \
  template bool CheckZAxpPxArgs(                                               \
      const DistTensor<T> &X, const DistTensor<T> &Y, const Permutation &perm, \
      const DistTensor<T> &Z);                                                 \
  template void GenZAxpBypPx(T alpha, const DistTensor<T> &X, T beta,          \
                             const DistTensor<T> &Y, const Permutation &perm,  \
                             DistTensor<T> &Z);
