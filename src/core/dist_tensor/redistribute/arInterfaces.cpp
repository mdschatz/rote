...
template <typename T>
void DistTensor<T>::AllReduceUpdateRedistFrom(const T alpha,
...
template <typename T>
void DistTensor<T>::AllReduceRedistFrom(const DistTensor<T> &A,
                                        const ModeArray &rModes) {
...
template <typename T>
void DistTensor<T>::AllReduceUpdateRedistFrom(const DistTensor<T> &A,
                                              const T beta,
