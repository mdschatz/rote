...
void DistTensorTest(const Grid &g, Unsigned tenDimFive,
  ...
  TensorDistribution dist__D_0_2__D_1__S__D_3 =
...
s 4 dims
  ...
  t_efmn__D_0__D_1__S__D_3.AllGatherRedistFrom(t_efmn__D_0__D_1__D_2__D_3, 2,
                                               modes_2);
  // t_efmn[D0,D1,*,*] <- t_efmn[D0,D1,*,D3]
  t_efmn__D_0__D_1__S__S.AllGatherRedistFrom(t_efmn__D_0__D_1__S__D_3, 3,
                                             modes_3);
  // t_efmn[D02,D1,*,D3] <- t_efmn[D0,D1,*,D3]
  t_efmn__D_0_2__D_1__S__D_3.LocalRedistFrom(t_efmn__D_0__D_1__S__D_3, 0,
                                             modes_2);
  /
/ t_efmn[D20,D1,*,D3] <- t_efmn[D02,D1,*,D3]
  t_efmn__D_2_0__D_1__S__D_3.PermutationRedistFrom(t_efmn__D_0_2__D_1__S__D_3,
                                                   0, modes_0_2);
  // t_efmn[D2,D1,*,D3] <- t_efmn[D20,D1,*,D3]
  t_efmn__D_2__D_1__S__D_3.AllGatherRedistFrom(t_efmn__D_2_0__D_1__S__D_3, 0,
                                               modes_0);
  // t_efmn[D2,D3,*,D1] <- t_efmn[D2,D1,*,D3]
  t_efmn__D_2__D_3__S__D_1.AllToAllRedistFrom(
      t_efmn__D_2__D_1__S__D_3, modes_1_3, modes_3_1, modeArrayArray___1___3);
  // t_efmn[D2,D1,*,D30] <- t_efmn[D2,D1,*,D3]
  t_efmn__D_2__D_1__S__D_3_0.LocalRedistFrom(t_efmn__D_2__D_1__S__D_3, 3,
                                             modes_0);
  // t_efmn[D2,D1,*,D03] <- t_efmn[D2,D1,*,D30]
  t_efmn__D_2__D_1__S__D_0_3.PermutationRedistFrom(t_efmn__D_2__D_1__S__D_3_0,
                                                   3, modes_3_0);
  // t_efmn[D2,D1,*,D0] <- t_efmn[D2,D1,*,D03]
  t_efmn__D_2__D_1__S__D_0.AllGatherRedistFrom(t_efmn__D_2__D_1__S__D_0_3, 3,
                                               modes_3);
  // t_efmn[D2,D3,*,*] <- t_efmn[D2,D3,*,D1]
  t_efmn__D_2__D_3__S__S.AllGatherRedistFrom(t_efmn__D_2__D_3__S__D_1, 3,
                                             modes_1);
  // t_efmn[D2,*,*,D0] <- t_efmn[D2,D1,*,D0]
  t_efmn__D_2__S__S__D_0.AllGatherRedistFrom(t_efmn__D_2__D_1__S__D_0, 1,
                                             modes_1);
  ...
  // 1.0 * v2_oegm[D0,D1,D2,D3]_oegm * t_efmn[D2,*,*,D0]_gfno + 0.0 *
  // cont1_temp[D1,*,D3,*,D2,D0]_efmngo
  LocalContract(1.0, v2_oegm__D_0__D_1__D_2__D_3.LockedTensor(), indices_oegm,
                t_efmn__D_2__S__S__D_0.LockedTensor(), indices_gfno, 0.0,
  ...
  accum_temp_temp__D_0__D_1__D_2__D_3.AllToAllRedistFrom(
      ...
      modeArrayArray___1___2___3___0);
  // Print(accum_temp_temp__D_0__D_1__D_2__D_3, "After Contract:
  // accum_temp_temp__D_0__D_1__D_2__D_3");
  ...
  // 0.5 * v_efgh[D0,D1,D2,D3]_efgh * t_efmn[D2,D3,*,*]_ghmn + 0.0 *
  // accum_temp[D0,D1,*,*,D2,D3]_efmngh
  LocalContract(0.5, v_efgh__D_0__D_1__D_2__D_3.LockedTensor(), indices_efgh,
                t_efmn__D_2__D_3__S__S.LockedTensor(), indices_ghmn, 0.0,
                accum_temp__D_0__D_1__S__S__D_2__D_3.Tensor(), indices_efmngh);
  // Print(accum_temp__D_0__D_1__S__S__D_2__D_3, "After Contract:
  // accum_temp__D_0__D_1__S__S__D_2__D_3");
  //**** (out of 1)
  //**** Is a shadow
  //------------------------------------//
  ...
  // Print(accum_temp__D_0__D_1__D_2__D_3, "After Contract:
  // accum_temp__D_0__D_1__D_2__D_3");

  //------------------------------------//

  //****
  // 0.5 * v_opmn[*,*,D2,D3]_opmn * t_efmn[D0,D1,*,*]_efop + 1.0 *
  // accum_temp[D0,D1,D2,D3]_efmn
  LocalContractAndLocalEliminate(
      0.5, v_opmn__S__S__D_2__D_3.LockedTensor(), indices_opmn,
      t_efmn__D_0__D_1__S__S.LockedTensor(), indices_efop, 1.0,
      accum_temp__D_0__D_1__D_2__D_3.Tensor(), indices_efmn);
  // Print(accum_temp__D_0__D_1__D_2__D_3, "After Contract:
  // accum_temp__D_0__D_1__D_2__D_3");
  // 2.0 * axppx2_temp[D0,D1,D2,D3]_efmn * accum_temp[D0,D1,D2,D3]_efmn + 0.0 *
  // E_MP3[D0,D1,D2,D3]_efmn
  LocalContract(2.0, axppx2_temp__D_0__D_1__D_2__D_3.LockedTensor(),
 ...
 std::endl;
  ...
  // if(commRank == 0)
  //  std::cout << "commMap size: " << E_MP3____N_D_0_1_2_3.CommMapSize() <<
  //  std::endl;
  ...
  ); diffTensor.ResizeTo(C_local); Diff( C_local.LockedTensor(),
  C_local_comparison.LockedTensor(), diffTensor.Tensor() );

  if (commRank == 0) {
    cout << "Norm of distributed is " << Norm(C_local_comparison.LockedTensor())
  << endl; cout << "Norm of local is " << Norm(C_local.LockedTensor()) << endl;
