...
DistTensorTest( const Grid& g, Unsigned tenDimFive, Unsigned tenDimFiftyThree, Unsigned blkSize )
{
  ...
  DistTensor<double> axppx2_temp_part0_1_part2_1__S__D_1__S__D_3( dist__S__D_1__S__D_3, g );
  ...
  DistTensor<double> axppx3_temp_part2_1_part0_1__S__D_0__S__D_2( dist__S__D_0__S__D_2, g );
  ...
  DistTensor<double> t_efmn_part0_1_part3_1__S__D_1__D_3__S( dist__S__D_1__D_3__S, g );
  ...
  DistTensor<double> t_efmn_part2_1_part3_1__D_0__D_1__S__S( dist__D_0__D_1__S__S, g );
  ...
  DistTensor<double> v2_oegm_part2_1_part0_1__S__D_0__S__D_2( dist__S__D_0__S__D_2, g );
  ...
  DistTensor<double> v_opmn_part0_1_part1_1__S__S__D_2__D_3( dist__S__S__D_2__D_3, g );
...
//**** (out of 1)
    ...
    while(v2_oegm_part2T__D_0__D_1__D_2__D_3.Dimension(2) < v2_oegm__D_0__D_1__D_2__D_3.Dimension(2))
    {
        ...
        while(v2_oegm_part2_1_part0T__D_0__D_1__D_2__D_3.Dimension(0) < v2_oegm_part2_1__D_0__D_1__D_2__D_3.Dimension(0))
        {
            ...
            v2_oegm_part2_1_part0_1__S__D_0__S__D_2.AllGatherRedistFrom( v2_oegm_part2_1_part0_1__D_1__D_0__D_3__D_2, modes_0_2, modeArrayArray___1___3 );
            v2_oegm_part2_1_part0_1__D_1__D_0__D_3__D_2.EmptyData();
               // t_efmn_part0_1_part3_1[*,D1,D3,*] <- t_efmn_part0_1_part3_1[D0,D1,D3,D2]
            t_efmn_part0_1_part3_1__S__D_1__D_3__S.AllGatherRedistFrom( t_efmn_part0_1_part3_1__D_0__D_1__D_3__D_2, modes_0_3, modeArrayArray___0___2 );
            t_efmn_part0_1_part3_1__D_0__D_1__D_3__D_2.EmptyData();
               // 1.0 * v2_oegm_part2_1_part0_1[*,D0,*,D2]_oegm * t_efmn_part0_1_part3_1[*,D1,D3,*]_gfno + 1.0 * cont1_temp[D0,D1,D2,D3]_efmn
            LocalContractAndLocalEliminate(1.0, v2_oegm_part2_1_part0_1__S__D_0__S__D_2.LockedTensor(), indices_oegm, true,
                t_efmn_part0_1_part3_1__S__D_1__D_3__S.LockedTensor(), indices_gfno, true,
...
//    Print(accum_temp__D_0__D_1__D_2__D_3, "accum after YAxpPx");
    ...
    while(axppx3_temp_part2T__D_0__D_1__D_2__D_3.Dimension(2) < axppx3_temp__D_0__D_1__D_2__D_3.Dimension(2))
    {
        ...
        while(axppx3_temp_part2_1_part0T__D_0__D_1__D_2__D_3.Dimension(0) < axppx3_temp_part2_1__D_0__D_1__D_2__D_3.Dimension(0))
        {
            ...
            axppx2_temp_part0_1_part2_1__S__D_1__S__D_3.AllGatherRedistFrom( axppx2_temp_part0_1_part2_1__D_0__D_1__D_2__D_3, modes_0_2, modeArrayArray___0___2 );
               // axppx3_temp_part2_1_part0_1[*,D0,*,D2] <- axppx3_temp_part2_1_part0_1[D1,D0,D3,D2]
            axppx3_temp_part2_1_part0_1__S__D_0__S__D_2.AllGatherRedistFrom( axppx3_temp_part2_1_part0_1__D_1__D_0__D_3__D_2, modes_0_2, modeArrayArray___1___3 );
            axppx3_temp_part2_1_part0_1__D_1__D_0__D_3__D_2.EmptyData();
               // 0.5 * axppx3_temp_part2_1_part0_1[*,D0,*,D2]_oegm * axppx2_temp_part0_1_part2_1[*,D1,*,D3]_gfon + 1.0 * accum_temp[D0,D1,D2,D3]_efmn
            LocalContractAndLocalEliminate(0.5, axppx3_temp_part2_1_part0_1__S__D_0__S__D_2.LockedTensor(), indices_oegm, true,
                axppx2_temp_part0_1_part2_1__S__D_1__S__D_3.LockedTensor(), indices_gfon, true,
...
//    Print(accum_temp__D_0__D_1__D_2__D_3, "accum after axppx3 and 2");
    ...
    while(v_opmn_part0T__D_0__D_1__D_2__D_3.Dimension(0) < v_opmn__D_0__D_1__D_2__D_3.Dimension(0))
    {
        ...
        while(v_opmn_part0_1_part1T__D_0__D_1__D_2__D_3.Dimension(1) < v_opmn_part0_1__D_0__D_1__D_2__D_3.Dimension(1))
        {
            ...
            v_opmn_part0_1_part1_1__S__S__D_2__D_3.AllGatherRedistFrom( v_opmn_part0_1_part1_1__D_0__D_1__D_2__D_3, modes_0_1, modeArrayArray___0___1 );
               // t_efmn_part2_1_part3_1[D0,D1,*,*] <- t_efmn_part2_1_part3_1[D0,D1,D2,D3]
            t_efmn_part2_1_part3_1__D_0__D_1__S__S.AllGatherRedistFrom( t_efmn_part2_1_part3_1__D_0__D_1__D_2__D_3, modes_2_3, modeArrayArray___2___3 );
               // 0.5 * v_opmn_part0_1_part1_1[*,*,D2,D3]_opmn * t_efmn_part2_1_part3_1[D0,D1,*,*]_efop + 1.0 * accum_temp[D0,D1,D2,D3]_efmn
            LocalContractAndLocalEliminate(0.5, v_opmn_part0_1_part1_1__S__S__D_2__D_3.LockedTensor(), indices_opmn, true,
                t_efmn_part2_1_part3_1__D_0__D_1__S__S.LockedTensor(), indices_efop, true,
                1.0, accum_temp__D_0__D_1__D_2__D_3.Tensor(), indices_efmn, true);
    ...
    t_efmn__D_0__D_1__D_2__D_3.EmptyData();
...
//            Print(axppx2_temp_part0_1_part1_1__D_0__D_1__D_2__D_3, "axppx2 going in");
//            Print(accum_temp_part0_1_part1_1__D_0__D_1__D_2__D_3, "accum going in");
