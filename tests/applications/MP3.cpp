...
//      std::cout << "done" << std::endl;
    ...
    LocalContractAndLocalEliminate(0.5, axppx3_temp_local.LockedTensor(), indices_oegm,
		  ...
		  0.0, accum_temp_local.Tensor(), indices_efmn);
    YxpBy( accum_temp_local, -1.0, accum_temp_local );
...
//    DistTensor<T> E_MP3_local_comparison( tmen::StringToTensorDist("[]|(0,1,2,3)"), g);
//    GatherAllModes(E_MP3____N_D_0_1_2_3, E_MP3_local_comparison);
