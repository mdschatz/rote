...
void GatherAllModes(const DistTensor<T> &A, DistTensor<T> &B) {
  ...
  for (Unsigned mode = 0; mode < A.Order(); ++mode) {
    ...
    if (!(modeDist.empty())) {
      ...
      newIgnoreDist.insert(newIgnoreDist.end(), modeDist.begin(),
                           modeDist.end());
  ...
  if (tmp) {
    ...
    if (TensorDistToString(B.TensorDist()) !=
        TensorDistToString(tmp->TensorDist())) {
...
template <typename T> void Set(DistTensor<T> &A) {
  MakeUniform(A);
  /*
...
template <typename T>
void DistTensorTest(Unsigned tenDimFive, Unsigned tenDimFiftyThree,
                    const Grid &g) {
#ifndef RELEASE
  ...
  TensorDistribution dist__D_1__S__D_3__S__D_2__D_0 =
      rote::StringToTensorDist("[(1),(),(3),(),(2),(0)]");
  TensorDistribution dist__D_1__D_2__D_3__D_0 =
      rote::StringToTensorDist("[(1),(2),(3),(0)]");
  TensorDistribution dist__D_2__S__S__D_0 =
      rote::StringToTensorDist("[(2),(),(),(0)]");
  TensorDistribution dist__D_2__S__D_0__S =
      rote::StringToTensorDist("[(2),(),(0),()]");
  TensorDistribution dist__D_2__D_1__S__D_0 =
      rote::StringToTensorDist("[(2),(1),(),(0)]");
  TensorDistribution dist__D_2__D_1__S__D_3 =
      rote::StringToTensorDist("[(2),(1),(),(3)]");
  TensorDistribution dist__D_2__D_1__D_0__S =
      rote::StringToTensorDist("[(2),(1),(0),()]");
  TensorDistribution dist__D_2__D_1__D_0__D_3 =
      rote::StringToTensorDist("[(2),(1),(0),(3)]");
  TensorDistribution dist__D_2__D_1__D_3__D_0 =
      rote::StringToTensorDist("[(2),(1),(3),(0)]");
  ...
  DistTensor<double> accum_temp__D_0__D_1__D_2__D_3(dist__D_0__D_1__D_2__D_3,
                                                    g);
  // accum_temp[D0,D1,*,*,D2,D3]
  DistTensor<double> accum_temp__D_0__D_1__S__S__D_2__D_3(
      dist__D_0__D_1__S__S__D_2__D_3, g);
  // accum_temp[D1,*,D3,*,D2,D0]
  DistTensor<double> accum_temp__D_1__S__D_3__S__D_2__D_0(
      dist__D_1__S__D_3__S__D_2__D_0, g);
  // accum_temp_temp[D0,D1,D2,D3]
  DistTensor<double> accum_temp_temp__D_0__D_1__D_2__D_3(
      dist__D_0__D_1__D_2__D_3, g);
  // accum_temp_temp[D1,D2,D3,D0]
  DistTensor<double> accum_temp_temp__D_1__D_2__D_3__D_0(
      dist__D_1__D_2__D_3__D_0, g);
  // axppx2_temp[D0,D1,D2,D3]
  DistTensor<double> axppx2_temp__D_0__D_1__D_2__D_3(dist__D_0__D_1__D_2__D_3,
                                                     g);
  // axppx2_temp[D2,D1,D0,D3]
  DistTensor<double> axppx2_temp__D_2__D_1__D_0__D_3(dist__D_2__D_1__D_0__D_3,
                                                     g);
  ...
  DistTensor<double> axppx4_temp__D_0__D_1__D_2__D_3(dist__D_0__D_1__D_2__D_3,
                                                     g);
  // cont1_temp[D0,D1,D2,D3]
  DistTensor<double> cont1_temp__D_0__D
_1__D_2__D_3(dist__D_0__D_1__D_2__D_3,
                                                    g);
  // cont1_temp[D0,D1,D3,D2]
  DistTensor<double> cont1_temp__D_0__D_1__D_3__D_2(dist__D_0__D_1__D_3__D_2,
                                                    g);
  // cont1_temp[D1,D2,D3,D0]
  DistTensor<double> cont1_temp__D_1__D_2__D_3__D_0(dist__D_1__D_2__D_3__D_0,
                                                    g);
  // cont1_temp[D1,*,D3,*,D2,D0]
  DistTensor<double> cont1_temp__D_1__S__D_3__S__D_2__D_0(
      dist__D_1__S__D_3__S__D_2__D_0, g);
  // t_efmn[D0,D1,D2,D3]
  ...
  axppx4_temp__D_0__D_1__D_2__D_3_tempShape.push_back(fiftythree);
  axppx4_temp__D_0__D_1__D_2__D_3_tempShape.push_back(fiftythree);
  axppx4_temp__D_0__D_1__D_2__D_3_tempShape.push_back(five);
  axppx4_temp__D_0__D_1__D_2__D_3_tempShape.push_back(five);
  axppx4_temp__D_0__D_1__D_2__D_3.ResizeTo(
      axppx4_temp__D_0__D_1__D_2__D_3_tempShape);
  MakeUniform(axppx4_temp__D_0__D_1__D_2__D_3);
  DistTensor<T> axppx4_temp_local(
      rote::StringToTensorDist("[(),(),(),()]|(0,1,2,3)"), g);
  ...
  DistTensor<T> v_opmn_local(
      rote::StringToTensorDist("[(),(),(),()]|(0,1,2,3)"), g);
  GatherAllModes(v_o
pmn__D_0__D_1__D_2__D_3, v_opmn_local);
  // t_efop has 4 dims
  //	Starting distribution: [D0,D1,D2,D3] or _D_0__D_1__D_2__D_3
  ObjShape t_efop__D_0__D_1__D_2__D_3_tempShape;
  t_efop__D_0__D_1__D_2__D_3_tempShape.push_back(fiftythree);
  t_efop__D_0__D_1__D_2__D_3_tempShape.push_back(fiftythree);
  t_efop__D_0__D_1__D_2__D_3_tempShape.push_back(five);
  t_efop__D_0__D_1__D_2__D_3_tempShape.push_back(five);
  t_efop__D_0__D_1__D_2__D_3.ResizeTo(t_efop__D_0__D_1__D_2__D_3_tempShape);
  MakeUniform(t_efop__D_0__D_1__D_2__D_3);
  DistTensor<T> t_efop_local(
      rote::StringToTensorDist("[(),(),(),()]|(0,1,2,3)"), g);
  ...
  t_ghmn__D_0__D_1__D_2__D_3_tempShape.push_back(fiftythree);
  t_ghmn__D_0__D_1__D_2__D_3_tempShape.push_back(fiftythree);
  t_ghmn__D_0__D_1__D_2__D_3_tempShape.push_back(five);
  t_ghmn__D_0__D_1__D_2__D_3_tempShape.push_back(five);
  t_ghmn__D_0__D_1__D_2__D_3.ResizeTo(t_ghmn__D_0__D_1__D_2__D_3_tempShape);
  MakeUniform(t_ghmn__D_0__D_1__D_2__D_3);
  DistTensor<T> t_ghmn_local(
      rote::StringToTensorDist("[(),(),(),()]|(0,1,2,3)"), g);
  ...
  t_gfon__D_0__D_1__D_2__D_3_tempShape.push_back(fiftythree);
  t_gfon__D_0__D_1__D_2__D_3_tempShape.push_back(fiftythree);
  t_gfon__D_0__D_1__D_2__D_3_tempShape.push_back(five);
  t_gfon__D_0__D_1__D_2__D_3_tempShape.push_back(five);
  t_gfon__D_0__D_1__D_2__D_3.ResizeTo(t_gfon__D_0__D_1__D_2__D_3_tempShape);
  MakeUniform(t_gfon__D_0__D_1__D_2__D_3);
  DistTensor<T> t_gfon_local(
      rote::StringToTensorDist("[(),(),(),()]|(0,1,2,3)"), g);
  ...
  DistTensor<T> accum_temp_temp_local(
      rote::StringToTensorDist("[(),(),(),()]|(0,1,2,3)"), g);
  GatherAllModes(accum_temp__D_0__D_1__D_2__D_3, accum_temp_temp_local);
  ...
  YAxpPx(2.0, t_efmn__D_0__D_1__D_2__D_3, -1.0, t_efmn__D_0__D_1__D_3__D_2,
         perm_0_1_3_2, axppx4_temp__D_0__D_1__D_2__D_3);
...
------------------------//
  ...
  t_gfon__D_0__D_1__D_3__D_2.AllToAllRedistFrom(
      t_gfon__D_0__D_1__D_2__D_3, modes_2_3, modes_3_2, modeArrayArray___2___3);
  YAxpPx(2.0, t_gfon__D_0__D_1__D_2__D_3, -1.0, t_gfon__D_0__D_1__D_3__D_2,
  ...
  t_gfon__D_2__D_1__D_0__D_3.AllToAllRedistFrom(
      t_gfon__D_0__D_1__D_2__D_3, modes_0_2, modes_2_0, modeArrayArray___0___2);
  // t_gfon[D2,D1,D3,D0] <- t_gfon[D2,D1,D0,D3]
  t_gfon__D_2__D_1__D_3__D_0.AllToAllRedistFrom(
      t_gfon__D_2__D_1__D_0__D_3, modes_2_3, modes_3_2, modeArrayArray___0___3);
  // t_gfon[D2,D1,*,D0] <- t_gfon[D2,D1,D3,D0]
  t_gfon__D_2__D_1__S__D_0.AllGatherRedistFrom(t_gfon__D_2__D_1__D_3__D_0, 2,
                                               modes_3);
  // t_gfon[D2,*,*,D0] <- t_gfon[D2,D1,*,D0]
  t_gfon__D_2__S__S__D_0.AllGatherRedistFrom(t_gfon__D_2__D_1__S__D_0, 1,
                                             modes_1);

  //------------------------------------//

  //****
  // 1.0 * v2_oegm[D0,D1,D2,D3]_oegm * t_gfon[D2,*,*,D0]_gfno + 0.0 *
  // cont1_temp[D1,*,D3,*,D2,D0]_efmngo

  LocalContract(1.0, v2_oegm__D_0__D_1__D_2__D_3.LockedTensor(), indices_oegm,
                t_gfon__D_2__S__S__D_0.LockedTensor(), indices_gfno, 0.0,
                cont1_temp__D_1__S__D_3__S__D_2__D_0.Tensor(), indices_efmngo);
  //**** (out of 1)
  //**** Is real
  //------------------------------------//

  // cont1_temp[D1,D2,D3,D0] <- cont1_temp[D1,*,D3,*,D2,D0] (with SumScatter on
  // (D2)(D0))
  cont1_temp__D_1__D_2__D_3__D_0.ReduceScatterRedistFrom(
      cont1_temp__D_1__S__D_3__S__D_2__D_0, modes_5_4, modes_3_1);
  // cont1_temp[D0,D1,D2,D3] <- cont1_temp[D1,D2,D3,D0]
  cont1_temp__D_0__D_1__D_2__D_3.AllToAllRedistFrom(
      cont1_temp__D_1__D_2__D_3__D_0, modes_0_1_2_3, modes_1_2_3_0,
      modeArrayArray___1___2___3___0);
  ...
  v_opmn__S__D_1__D_2__D_3.AllGatherRedistFrom(v_opmn__D_0__D_1__D_2__D_3, 0,
                                               modes_0);
  // v_opmn[*,*,D2,D3] <- v_opmn[*,D1,D2,D3]
  v_opmn__S__S__D_2__D_3.AllGatherRedistFrom(v_opmn__S__D_1__D_2__D_3, 1,
                                             modes_1);
  ...
  t_efop__D_0__D_1__D_2__S.AllGatherRedistFrom(t_efop__D_0__D_1__D_2__D_3, 3,
                                               modes_3);
  // t_efop[D0,D1,*,*] <- t_efop[D0,D1,D2,*]
  t_efop__D_0__D_1__S__S.AllGatherRedistFrom(t_efop__D_0__D_1__D_2__S, 2,
                                             modes_2);
  ...
  t_ghmn__D_2__D_1__D_0__D_3.AllToAllRedistFrom(
      t_ghmn__D_0__D_1__D_2__D_3, modes_0_2, modes_2_0, modeArrayArray___0___2);
  // t_ghmn[D2,D1,*,D3] <- t_ghmn[D2,D1,D0,D3]
  t_ghmn__D_2__D_1__S__D_3.AllGatherRedistFrom(t_ghmn__D_2__D_1__D_0__D_3, 2,
                                               modes_0);
  // t_ghmn[D2,D3,*,D1] <- t_ghmn[D2,D1,*,D3]
  t_ghmn__D_2__D_3__S__D_1.AllToAllRedistFrom(
      t_ghmn__D_2__D_1__S__D_3, modes_1_3, modes_3_1, modeArrayArray___1___3);
  // t_ghmn[D2,D3,*,*] <- t_ghmn[D2,D3,*,D1]
  t_ghmn__D_2__D_3__S__S.AllGatherRedistFrom(t_ghmn__D_2__D_3__S__D_1, 3,
                                             modes_1);
  ...
  axppx2_temp__D_2__D_1__D_0__D_3.AllToAllRedistFrom(
      axppx2_temp__D_0__D_1__D_2__D_3, modes_0_2, modes_2_0,
      modeArrayArray___0___2);
  // axppx2_temp[D2,D1,D0,*] <- axppx2_temp[D2,D1,D0,D3]
  axppx2_temp__D_2__D_1__D_0__S.AllGatherRedistFrom(
      axppx2_temp__D_2__D_1__D_0__D_3, 3, modes_3);
  // axppx2_temp[D2,*,D0,*] <- axppx2_temp[D2,D1,D0,*]
  axppx2_temp__D_2__S__D_0__S.AllGatherRedistFrom(axppx2_temp__D_2__D_1__D_0__S,
                                                  1, modes_1);

  //------------------------------------//

  //****
  // 0.5 * axppx3_temp[D0,D1,D2,D3]_oegm * axppx2_temp[D2,*,D0,*]_gfon + 0.0 *
  // accum_temp[D1,*,D3,*,D2,D0]_efmngo

  LocalContract(0.5, axppx3_temp__D_0__D_1__D_2__D_3.LockedTensor(),
                indices_oegm, axppx2_temp__D_2__S__D_0__S.LockedTensor(),
                indices_gfon, 0.0,
                accum_temp__D_1__S__D_3__S__D_2__D_0.Tensor(), indices_efmngo);
  //**** (out of 1)
  //**** Is a shadow
  //------------------------------------//

  // accum_temp_temp[D1,D2,D3,D0] <- accum_temp[D1,*,D3,*,D2,D0] (with
  // SumScatter on (D2)(D0))
  accum_temp_temp__D_1__D_2__D_3__D_0.ReduceScatterRedistFrom(
      accum_temp__D_1__S__D_3__S__D_2__D_0, modes_5_4, modes_3_1);
  // accum_temp_temp[D0,D1,D2,D3] <- accum_temp_temp[D1,D2,D3,D0]
  accum_temp_temp__D_0__D_1__D_2__D_3.AllToAllRedistFrom(
      accum_temp_temp__D_1__D_2__D_3__D_0, modes_0_1_2_3, modes_1_2_3_0,
      modeArrayArray___1___2___3___0);

  //------------------------------------//

  //****
  YxpBy(accum_temp_temp__D_0__D_1__D_2__D_3, -1.0,
        accum_temp__D_0__D_1__D_2__D_3);
  tempShape = accum_temp__D_0__D_1__D_2__D_3.Shape();
  tempShape.push_back(g.Shape()[2]);
  tempShape.push_back(g.Shape()[3]);
  accum_temp__D_0__D_1__S__S__D_2__D_3.ResizeTo(tempShape);
  // 0.5 * v_efgh[D0,D1,D2,D3]_efgh * t_ghmn[D2,D3,*,*]_ghmn + 0.0 *
  // accum_temp[D0,D1,*,*,D2,D3]_efmngh

  LocalContract(0.5, v_efgh__D_0__D_1__D_2__D_3.LockedTensor(), indices_efgh,
                t_ghmn__D_2__D_3__S__S.LockedTensor(), indices_ghmn, 0.0,
                accum_temp__D_0__D_1__S__S__D_2__D_3.Tensor(), indices_efmngh);
  //**** (out of 1)
  //**** Is a shadow
  //------------------------------------//

  // accum_temp[D0,D1,D2,D3] <- accum_temp[D0,D1,*,*,D2,D3] (with SumScatter on
  // (D2)(D3))
  accum_temp__D_0__D_1__D_2__D_3.ReduceScatterUpdateRedistFrom(
      accum_temp__D_0__D_1__S__S__D_2__D_3, 1.0, modes_5_4, modes_3_2);

  //------------------------------------//

  //****
  // 0.5 * v_opmn[*,*,D2,D3]_opmn * t_efop[D0,D1,*,*]_efop + 1.0 *
  // accum_temp[D0,D1,D2,D3]_efmn

  LocalContractAndLocalEliminate(
      0.5, v_opmn__S__S__D_2__D_3.LockedTensor(), indices_opmn,
      t_efop__D_0__D_1__S__S.LockedTensor(), indices_efop, 1.0,
      accum
_temp__D_0__D_1__D_2__D_3.Tensor(), indices_efmn);
  ...
  // 2.0 * axppx4_temp[D0,D1,D2,D3]_efmn * accum_temp[D0,D1,D2,D3]_efmn + 0.0 *
  // E_MP3[D0,D1,D2,D3]_efmn

  LocalContract(2.0, axppx4_temp__D_0__D_1__D_2__D_3.LockedTensor(),
                indices_efmn, accum_temp__D_0__D_1__D_2__D_3.LockedTensor(),
                indices_efmn, 0.0, E_MP3__D_0__D_1__D_2__D_3.Tensor(),
                indices_efmn);
  // E_MP3[] | {0,1,2,3} <- E_MP3[D0,D1,D2,D3] (with SumScatter on
  // (D0)(D1)(D2)(D3))
  E_MP3____N_D_0_1_2_3.ReduceToOneRedistFrom(E_MP3__D_0__D_1__D_2__D_3,
                                             modes_0_1_2_3);
  ...
  YAxpPx(2.0, t_efmn_local, -1.0, t_efmn_local, perm_0_1_3_2,
         axppx4_temp_local);
  ZAxpBy(2.0, v_oegm_local, -1.0, v2_oegm_local, axppx3_temp_local);
  YAxpPx(2.0, t_gfon_local, -1.0, t_gfon_local, perm_0_1_3_2,
         axppx2_temp_local);
  LocalContractAndLocalEliminate(1.0, v2_oegm_local.LockedTensor(),
                                 indices_oegm, t_gfon_local.LockedTensor(),
                                 indices_gfno, 0.0, cont1_temp_local.Tensor(),
                                 indices_efmn);
  YAxpPx(0.5, cont1_temp_local, 1.0, cont1_temp_local, perm_0_1_3_2,
         accum_temp_local);
  LocalContractAndLocalEliminate(0.5, axppx3_temp_local.LockedTensor(),
                                 indices_oegm, axppx2_temp_local.LockedTensor(),
                                 indices_gfon, 0.0,
                                 accum_temp_temp_local.Tensor(), indices_efmn);
  YxpBy(accum_temp_temp_local, -1.0, accum_temp_local);
  LocalContractAndLocalEliminate(0.5, v_efgh_local.LockedTensor(), indices_efgh,
                                 t_ghmn_local.LockedTensor(), indices_ghmn, 1.0,
                                 accum_temp_local.Tensor(), indices_efmn);
  LocalContractAndLocalEliminate(0.5, v_opmn_local.LockedTensor(), indices_opmn,
                                 t_efop_local.LockedTensor(), indices_efop, 1.0,
                                 accum_temp_local.Tensor(), indices_efmn);
  IndexArray blank_indices;

  LocalContractAndLocalEliminate(2.0, axppx4_temp_local.LockedTensor(),
                                 indices_efmn, accum_temp_local.LockedTensor(),
                                 indices_efmn, 0.0, E_MP3_local.Tensor(),
                                 blank_indices);

  Unsigned flops = pow(fiftythree, 2) * pow(five, 2) * (6742);
  gflops = flops / (1.e9 * runTime);

  //****

  DistTensor<T> diffTensor(rote::StringToTensorDist("[]|(0,1,2,3)"), g);
  diffTensor.ResizeTo(E_MP3____N_D_0_1_2_3);
  Diff(E_MP3____N_D_0_1_2_3.LockedTensor(), E_MP3_local.LockedTensor(),
       diffTensor.Tensor());

  if (commRank == 0) {
    cout << "Norm of distributed is "
         << Norm(E_MP3____N_D_0_1_2_3.LockedTensor()) << endl;
    cout << "Norm of local is " << Norm(E_MP3_local.LockedTensor()) << endl;
    cout << "Norm is " << Norm(diffTensor.LockedTensor()) << endl;
    cout << "GFlops is " << gflops << endl;
    cout << "Time is " << runTime << std::endl;
  }
}
...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    DistTensorTest<double>(args.tenDimFive, args.tenDimFiftyThree, g);
