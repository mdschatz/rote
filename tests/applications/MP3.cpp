...
DistTensorTest( Unsigned tenDimFive, Unsigned tenDimFiftyThree, const Grid& g )
{
  ...
  TensorDistribution dist__D_1__S__D_3__S__D_2__D_0 = rote::StringToTensorDist("[(1),(),(3),(),(2),(0)]");
  TensorDistribution dist__D_1__D_2__D_3__D_0 = rote::StringToTensorDist("[(1),(2),(3),(0)]");
  TensorDistribution dist__D_2__S__S__D_0 = rote::StringToTensorDist("[(2),(),(),(0)]");
  TensorDistribution dist__D_2__S__D_0__S = rote::StringToTensorDist("[(2),(),(0),()]");
  TensorDistribution dist__D_2__D_1__S__D_0 = rote::StringToTensorDist("[(2),(1),(),(0)]");
  TensorDistribution dist__D_2__D_1__S__D_3 = rote::StringToTensorDist("[(2),(1),(),(3)]");
  TensorDistribution dist__D_2__D_1__D_0__S = rote::StringToTensorDist("[(2),(1),(0),()]");
  TensorDistribution dist__D_2__D_1__D_0__D_3 = rote::StringToTensorDist("[(2),(1),(0),(3)]");
  TensorDistribution dist__D_2__D_1__D_3__D_0 = rote::StringToTensorDist("[(2),(1),(3),(0)]");
  ...
  DistTensor<T> axppx4_temp_local( rote::StringToTensorDist("[(),(),(),()]|(0,1,2,3)"), g );
  ...
  DistTensor<T> t_efop_local( rote::StringToTensorDist("[(),(),(),()]|(0,1,2,3)"), g );
  ...
  DistTensor<T> t_ghmn_local( rote::StringToTensorDist("[(),(),(),()]|(0,1,2,3)"), g );
  ...
  DistTensor<T> t_gfon_local( rote::StringToTensorDist("[(),(),(),()]|(0,1,2,3)"), g );
  ...
  DistTensor<T> accum_temp_temp_local( rote::StringToTensorDist("[(),(),(),()]|(0,1,2,3)"), g);
...
//        std::cout << "starting\n";
  ...
  //------------------------------------//
    ...
    LocalContractAndLocalEliminate(1.0, v2_oegm_local.LockedTensor(), indices_oegm,
		  t_gfon_local.LockedTensor(), indices_gfno,
		  0.0, cont1_temp_local.Tensor(), indices_efmn);
    YAxpPx( 0.5, cont1_temp_local, 1.0, cont1_temp_local, perm_0_1_3_2, accum_temp_local );
    LocalContractAndLocalEliminate(0.5, axppx3_temp_local.LockedTensor(), indices_oegm,
		  axppx2_temp_local.LockedTensor(), indices_gfon,
		  0.0, accum_temp_temp_local.Tensor(), indices_efmn);
    ...
    LocalContractAndLocalEliminate(0.5, v_efgh_local.LockedTensor(), indices_efgh,
		  t_ghmn_local.LockedTensor(), indices_ghmn,
		  1.0, accum_temp_local.Tensor(), indices_efmn);
    LocalContractAndLocalEliminate(0.5, v_opmn_local.LockedTensor(), indices_opmn,
				   t_efop_local.LockedTensor(), indices_efop,
				   1.0, accum_temp_local.Tensor(), indices_efmn);
    IndexArray blank_indices;

    LocalContractAndLocalEliminate(2.0, axppx4_temp_local.LockedTensor(), indices_efmn,
		  accum_temp_local.LockedTensor(), indices_efmn,
		  0.0, E_MP3_local.Tensor(), blank_indices);
  ...
  //****
    ...
    if (commRank == 0) {
      cout << "Norm of distributed is " << Norm(E_MP3____N_D_0_1_2_3.LockedTensor()) << endl;
