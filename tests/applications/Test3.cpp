...
template <typename T> void DistTensorTest(const Grid &g) {
#ifndef RELEASE
  ...
  TensorDistribution dist__D_0__S__D_2__S__D_1__D_3 =
  ...
  TensorDistribution dist__D_1__D_2__D_3__N_D_0 =
  ...
  TensorDistribution dist__D_2__D_3__N_D_0_1 =
  ...
  // Accum[D0,D1,D2,*,D3]
  DistTensor<double> Accum__D_0__D_1__D_2__S__D_3(dist__D_0__D_1__D_2__S__D_3,
                                                  g);
  // Accum[D0,D1,*,*,D2,D3]
  DistTensor<double> Accum__D_0__D_1__S__S__D_2__D_3(
      dist__D_0__D_1__S__S__D_2__D_3, g);
  // Accum[D0,*,D2,*,D1,D3]
  DistTensor<double> Accum__D_0__S__D_2__S__D_1__D_3(
      dist__D_0__S__D_2__S__D_1__D_3, g);
  // T[D02,D1,*,D3]
  ...
  // epsilon[D1,D2,D3] | {0}
  DistTensor<double> epsilon__D_1__D_2__D_3__N_D_0(dist__D_1__D_2__D_3__N_D_0,
                                                   g);
  // epsilon[D2,D3] | {0,1}
 ...
 = 'a';
  ...
  DistTensor<T> Accum_local(rote::StringToTensorDist("[(),(),(),()]|(0,1,2,3)"),
                            g);
  ...
  // Print(T__D_0__D_1__S__D_3,
  // rote::TensorDistToString(T__D_0__D_1__S__D_3.TensorDist()));
  // T[*,D1,*,D3] <- T[D0,D1,*,D3]
  T__S__D_1__S__D_3.AllGatherRedistFrom(T__D_0__D_1__S__D_3, 0, modes_0);
  // Print(T__S__D_1__S__D_3,
  // rote::TensorDistToString(T__S__D_1__S__D_3.TensorDist()));
  // T[D02,D1,*,D3] <- T[D0,D1,*,D3]
  T__D_0_2__D_1__S__D_3.LocalRedistFrom(T__D_0__D_1__S__D_3, 0, modes_2);
  // Print(T__D_0_2__D_1__S__D_3,
  // rote::TensorDistToString(T__D_0_2__D_1__S__D_3.TensorDist()));
  // T[D20,D1,*,D3] <- T[D02,D1,*,D3]
  T__D_2_0__D_1__S__D_3.PermutationRedistFrom(T__D_0_2__D_1__S__D_3, 0,
                                              modes_0_2);
  // Print(T__D_2_0__D_1__S__D_3,
  // rote::TensorDistToString(T__D_2_0__D_1__S__D_3.TensorDist()));
  // T[D2,D1,*,D3] <- T[D20,D1,*,D3]
  T__D_2__D_1__S__D_3.AllGatherRedistFrom(T__D_2_0__D_1__S__D_3, 0, modes_0);
  // Print(T__D_2__D_1__S__D_3,
  // rote::TensorDistToString(T__D_2__D_1__S__D_3.TensorDist()));
  // T[D2,D3,*,D1] <- T[D2,D1,*,D3]
  T__D_2__D_3__S__D_1.AllToAllDoubleModeRedistFrom(
      T__D_2__D_1__S__D_3, indexPair_1_3, modeArray_1__3);
  // Print(T__D_2__D_3__S__D_1,
  // rote::TensorDistToString(T__D_2__D_3__S__D_1.TensorDist()));
  // T[D2,D3,*,*] <- T[D2,D3,*,D1]
  T__D_2__D_3__S__S.AllGatherRedistFrom(T__D_2__D_3__S__D_1, 3, modes_1);
  // Print(T__D_2__D_3__S__S,
  // rote::TensorDistToString(T__D_2__D_3__S__S.TensorDist()));
  ...
  //****
  // 1.0 * U[D0,D1,D2,D3]_abcd * T[D2,D3,*,*]_cdij + 0.0 *
  // Accum[D0,D1,*,*,D2,D3]_abijcd
  LocalContract(1.0, U__D_0__D_1__D_2__D_3.LockedTensor(), indices_abcd,
                T__D_2__D_3__S__S.LockedTensor(), indices_cdij, 0.0,
                Accum__D_0__D_1__S__S__D_2__D_3.Tensor(), indices_abijcd);
  ...
  Accum__D_0__D_1__D_2__S__D_3.ReduceScatterRedistFrom(
      Accum__D_0__D_1__S__S__D_2__D_3, 4, 2);
  //  Print(Accum__D_0__D_1__D_2__S__D_3, "Post RTO D2");
  // Accum[D0,D1,D2,D3] <- Accum[D0,D1,D2,*,D3] (with SumScatter on D3)
  Accum__D_0__D_1__D_2__D_3.ReduceScatterRedistFrom(
      Accum__D_0__D_1__D_2__S__D_3, 4, 3);
  ...
  // 1.0 * V[D0,D1,D2,D3]_acik * T[*,D1,*,D3]_bcjk + 0.0 *
  // Accum[D0,*,D2,*,D1,D3]_abijck
  LocalContract(1.0, V__D_0__D_1__D_2__D_3.LockedTensor(), indices_acik,
                T__S__D_1__S__D_3.LockedTensor(), indices_bcjk, 0.0,
                Accum__D_0__S__D_2__S__D_1__D_3.Tensor(), indices_abijck);
  ...
  Accum__D_0__D_1__D_2__S__D_3.ReduceScatterRedistFrom(
      Accum__D_0__S__D_2__S__D_1__D_3, 4, 1);
  //  Print(Accum__D_0__D_1__D_2__S__D_3, "RTO D1");
  // Accum[D0,D1,D2,D3] <- Accum[D0,D1,D2,*,D3] (with SumScatter on D3)
  Accum__D_0__D_1__D_2__D_3.ReduceScatterUpdateRedistFrom(
      Accum__D_0__D_1__D_2__S__D_3, 1.0, 4, 3);
  ...
  //  PrintData(Accum__D_0__D_1__S__S__D_2__D_3, "Accum");
  //  Print(Accum__D_0__D_1__S__S__D_2__D_3, "Accum elem");
  // 1.0 * W[*,*,D2,D3]_ijkl * T[D0,D1,D2,D3]_abkl + 0.0 *
  // Accum[D0,D1,*,*,D2,D3]_abijkl
  LocalContract(1.0, W__S__S__D_2__D_3.LockedTensor(), indices_ijkl,
                T__D_0__D_1__D_2__D_3.LockedTensor(), indices_abkl, 0.0,
                Accum__D_0__D_1__S__S__D_2__D_3.Tensor(), indices_abijkl);
  //  Print(Accum__D_0__D_1__S__S__D_2__D_3, "post Accum elem");
  //**** (out of 1)
  //**** Is a shadow
  //------------------------------------//
  ...
  // 1.0 * T[D0,D1,D2,D3]_abij * Accum[D0,D1,D2,D3]_abij + 0.0 *
  // epsilon[D0,D1,D2,D3]_abij
  LocalContract(1.0, T__D_0__D_1__D_2__D_3.LockedTensor(), indices_abij,
                Accum__D_0__D_1__D_2__D_3.LockedTensor(), indices_abij, 0.0,
                epsilon__D_0__D_1__D_2__D_3.Tensor(), indices_abij);
  ...
  epsilon__D_1__D_2__D_3__N_D_0.ReduceToOneRedistFrom(
      epsilon__D_0__D_1__D_2__D_3, 0);
  ...
  epsilon__D_2__D_3__N_D_0_1.ReduceToOneRedistFrom(
      epsilon__D_1__D_2__D_3__N_D_0, 0);
  ...
  if (commRank == 0)
    std::cout << "done\n";
  gflops = 2 *
           ((pow(twenty, 4) * pow(ten, 2)) + (pow(ten, 3) * pow(twenty, 3)) +
            (pow(ten, 4) * pow(twenty, 2)) + (pow(twenty, 2) * pow(ten, 2))) /
           (1.e9 * runTime);
  //------------------------------------//

  LocalContractAndLocalEliminate(1.0, U_local.LockedTensor(), indices_abcd,
                                 T_local.LockedTensor(), indices_cdij, 0.0,
                                 Accum_local.Tensor(), indices_abij);

  LocalContractAndLocalEliminate(1.0, V_local.LockedTensor(), indices_acik,
                                 T_local.LockedTensor(), indices_bcjk, 1.0,
                                 Accum_local.Tensor(), indices_abij);

  LocalContractAndLocalEliminate(1.0, W_local.LockedTensor(), indices_ijkl,
                                 T_local.LockedTensor(), indices_abkl, 1.0,
                                 Accum_local.Tensor(), indices_abij);

  IndexArray blank_indices;

  LocalContractAndLocalEliminate(1.0, T_local.LockedTensor(), indices_abij,
                                 Accum_local.LockedTensor(), indices_abij, 0.0,
                                 epsilon_local.Tensor(), blank_indices);

  DistTensor<T> epsilon_local_comparison(
  ...
  Diff(epsilon_local_comparison.LockedTensor(), epsilon_local.LockedTensor(),
       diffTensor.Tensor());

  if (commRank == 0) {
    cout << "Norm of distributed is "
         << Norm(epsilon_local_comparison.LockedTensor()) << endl;
