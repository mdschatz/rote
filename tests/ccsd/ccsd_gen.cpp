...
void Usage() {
  std::cout << "./DistTensor <gridOrder> <gridDim0> <gridDim1> ... <n_o> <n_v> "
               "<block_size> <testIter> \n";
...
template <typename T>
void PrintNorm(const DistTensor<T> &check, const DistTensor<T> &actual,
               const char *msg) {
...
template <typename T>
void InitCheckTensor(const std::string &data_path, int testIter,
                     DistTensor<T> &TT) {
...
template <typename T>
void ComputeTW(const DistTensor<T> &Twsa, const DistTensor<T> &Trsa,
               const DistTensor<T> &Tusa, const DistTensor<T> &Tvsa,
               const DistTensor<T> &Ttau2sa, const DistTensor<T> &Tt,
               DistTensor<T> &TW, Unsigned blkSize) {
...
template <typename T>
void ComputeTX(const DistTensor<T> &Tx, const DistTensor<T> &Tv,
               const DistTensor<T> &Ttau2, const DistTensor<T> &Tu,
               const DistTensor<T> &Tt, const DistTensor<T> &Tr,
               DistTensor<T> &TX, Unsigned blkSize) {
  // X_bmej = x_bmej;
...
template <typename T>
void ComputeTU(const DistTensor<T> &Tu, const DistTensor<T> &Tv,
               const DistTensor<T> &Tt, DistTensor<T> &TU) {
  // U_mnie = u_mnie;
...
template <typename T>
void ComputeTQ(const DistTensor<T> &Tu, const DistTensor<T> &Tt,
               const DistTensor<T> &Tv, const DistTensor<T> &Ttau,
               const DistTensor<T> &Tq, DistTensor<T> &TQ, Unsigned blkSize) {
...
template <typename T>
void ComputeTP(const DistTensor<T> &Tu, const DistTensor<T> &Tr,
               const DistTensor<T> &Ttau, const DistTensor<T> &Tw,
               const DistTensor<T> &Tt, const DistTensor<T> &Tx,
               DistTensor<T> &TP, Unsigned blkSize) {
  // P_jimb = u_jimb
...
template <typename T>
void ComputeTH(const DistTensor<T> &Tvsa, const DistTensor<T> &Tt,
               DistTensor<T> &TH) {
...
template <typename T>
void ComputeTF(const DistTensor<T> &TH, const DistTensor<T> &Tt,
               const DistTensor<T> &Trsa, const DistTensor<T> &Tvsa,
               const DistTensor<T> &TT, DistTensor<T> &TF) {
...
template <typename T>
void ComputeTG(const DistTensor<T> &TH, const DistTensor<T> &Tt,
               const DistTensor<T> &Tusa, const DistTensor<T> &Tvsa,
               const DistTensor<T> &TT, DistTensor<T> &TG) {
...
template <typename T>
void ComputeTz(const DistTensor<T> &TG, const DistTensor<T> &Tt,
               const DistTensor<T> &TUsa, const DistTensor<T> &TT,
               const DistTensor<T> &Twsa, const DistTensor<T> &TTsa,
               const DistTensor<T> &TH, const DistTensor<T> &Trsa,
               const DistTensor<T> &Ttau, DistTensor<T> &Tz) {
...
template <typename T>
void ComputeTZ(const DistTensor<T> &TX
, const DistTensor<T> &TT,
               const DistTensor<T> &TW, const DistTensor<T> &TTsa,
               const DistTensor<T> &TG, const DistTensor<T> &TF,
               const DistTensor<T> &TP, const DistTensor<T> &Tt,
               const DistTensor<T> &Tr, const DistTensor<T> &Ty,
               const DistTensor<T> &Ttau, const DistTensor<T> &TQ,
               const DistTensor<T> &Tv, DistTensor<T> &TZ, Unsigned blkSize) {
