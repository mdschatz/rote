...
void RunReduceTest(const Grid &g, const char *outDist, const char *inDist,
...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    reduceModes[0] = 2;
    reduceModes[1] = 3;
    //        RunReduceTest(g, "[(0,4),(1,2,3)]", "[(0),(1,3),(4),(2)]",
    //        reduceModes); RunReduceTest(g, "[(0,4),(2,3)]",
    //        "[(0),(1,3),(4),(2)]", reduceModes);
