...
void Usage() {
  std::cout << "./Level1 <gridOrder> <gridDim0> <gridDim1> ... <ten1Order> "
               "<ten1Dim0> <ten1Dim1> ... \"<tensorDist>\"\n";
...
template <typename T> void Set(Tensor<T> &A) { MakeUniform(A); }

template <typename T> void TestElemScal(const DistTensor<T> &A) {
#ifndef RELEASE
...
template <typename T> void TestYAxpPx(const DistTensor<T> &A) {
#ifndef RELEASE
...
template <typename T> void TestZAxpBy(const DistTensor<T> &A) {
#ifndef RELEASE
...
template <typename T> void TestAxpy(const DistTensor<T> &A) {
#ifndef RELEASE
