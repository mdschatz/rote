...
void CreateAGTestsHelper(const ModeArray &tenModesToRedist,
...
std::vector<RedistTest> CreateAGTests(const TensorDistribution &distA) {
  Unsigned i;
...
#endif // ifndef ROTE_TESTS_AGGREDIST_HPP
