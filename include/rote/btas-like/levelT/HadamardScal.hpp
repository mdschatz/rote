...
////////////////////////////////////
template <typename T>
inline void HadamardScalBC_fast(T const *const bufA, T const *const bufB,
                                T *const bufC, const HadamardScalData &data) {
...
template <typename T>
inline void HadamardScalAC_fast(T const *const bufA, T const *const bufB,
                                T *const bufC, const HadamardScalData &data) {
...
////////////////////////////////////
template <typename T>
void HadamardScal(const Tensor<T> &A, const Tensor<T> &B, Tensor<T> &C,
