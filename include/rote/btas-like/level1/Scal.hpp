...
*/
#pragma once
#ifndef ROTE_BTAS_SCAL_HPP
#define ROTE_BTAS_SCAL_HPP
...
////////////////////////////////////
template <typename T>
inline void Scal_fast(T alpha, T *srcBuf, const ScalData &data) {
...
// Global interfaces
////////////////////////////////////
template <typename T> void Scal(T alpha, DistTensor<T> &X) {
  Scal(alpha, X.Tensor());
}

} // namespace rote

#endif // ifndef ROTE_BTAS_AXPY_HPP
