...
////////////////////////////////////
template <typename T>
void SetAllVal_fast(const ObjShape &shape, const std::vector<Unsigned> &strides,
                    T *const buf, T val) {
...
////////////////////////////////////
template <typename T>
inline void SetAllVal(Tensor<T> &A, T val) {
...
////////////////////////////////////
template <typename T>
inline void SetAllVal(DistTensor<T> &A, T val) {
