...
public:
  ...
  friend ModeDistribution GetCommonPrefix(const ModeDistribution &lhs,
                                          const ModeDistribution &rhs);
  friend ModeDistribution GetCommonSuffix(const ModeDistribution &lhs,
                                          const ModeDistribution &rhs);

  friend bool IsPrefix(const ModeDistribution &lhs,
                       const ModeDistribution &rhs);
  friend bool operator<(const ModeDistribution &lhs,
                        const ModeDistribution &rhs);
  friend bool operator>(const ModeDistribution &lhs,
                        const ModeDistribution &rhs);
  friend bool operator<=(const ModeDistribution &lhs,
  ...
  friend bool operator>=(const ModeDistribution &lhs,
                         const ModeDistribution &rhs);
  friend ModeDistribution operator+(const ModeDistribution &lhs,
                                    const ModeDistribution &rhs);
  friend ModeDistribution operator-(const ModeDistribution &lhs,
                                    const ModeDistribution &rhs);
