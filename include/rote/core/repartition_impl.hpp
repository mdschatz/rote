...
template <typename T>
inline void RepartitionUp(TEN &AT, TEN &A0, TEN &A1, TEN &AB, TEN &A2,
                          Mode mode, Unsigned A1Dimension) {
#ifndef RELEASE
...
template <typename T>
inline void RepartitionUp(DTEN &AT, DTEN &A0, DTEN &A1, DTEN &AB, DTEN &A2,
                          Mode mode, Unsigned A1Dimension) {
#ifndef RELEASE
...
template <typename T>
inline void LockedRepartitionUp(const TEN &AT, TEN &A0, TEN &A1, const TEN &AB,
                                TEN &A2, Mode mode, Unsigned A1Dimension) {
#ifndef RELEASE
...
template <typename T>
inline void LockedRepartitionUp(const DTEN &AT, DTEN &A0, DTEN &A1,
                                const DTEN &AB, DTEN &A2, Mode mode,
                                Unsigned A1Dimension) {
#ifndef RELEASE
...
template <typename T>
inline void RepartitionDown(TEN &AT, TEN &A0, TEN &A1, TEN &AB, TEN &A2,
                            Mode mode, Unsigned A1Dimension) {
#ifndef RELEASE
...
template <typename T>
inline void RepartitionDown(DTEN &AT, DTEN &A0, DTEN &A1, DTEN &AB, DTEN &A2,
                            Mode mode, Unsigned A1Dimension) {
#ifndef RELEASE
...
template <typename T>
inline void LockedRepartitionDown(const TEN &AT, TEN &A0, TEN &A1,
                                  const TEN &AB, TEN &A2, Mode mode,
                                  Unsigned A1Dimension) {
#ifndef RELEASE
...
template <typename T>
inline void LockedRepartitionDown(const DTEN &AT, DTEN &A0, DTEN &A1,
                                  const DTEN &AB, DTEN &A2, Mode mode,
                                  Unsigned A1Dimension) {
#ifndef RELEASE
