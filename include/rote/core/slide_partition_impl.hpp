...
template <typename T>
inline void SlidePartitionUp(TEN &AT, TEN &A0, TEN &A1, TEN &AB, TEN &A2,
                             Mode mode) {
#ifndef RELEASE
...
template <typename T>
inline void SlidePartitionUp(DTEN &AT, DTEN &A0, DTEN &A1, DTEN &AB, DTEN &A2,
                             Mode mode) {
#ifndef RELEASE
...
template <typename T>
inline void SlideLockedPartitionUp(TEN &AT, const TEN &A0, const TEN &A1,
...
template <typename T>
inline void SlideLockedPartitionUp(DTEN &AT, const DTEN &A0, const DTEN &A1,
...
template <typename T>
inline void SlidePartitionDown(TEN &AT, TEN &A0, TEN &A1, TEN &AB, TEN &A2,
                               Mode mode) {
#ifndef RELEASE
...
template <typename T>
inline void SlidePartitionDown(DTEN &AT, DTEN &A0, DTEN &A1, DTEN &AB, DTEN &A2,
                               Mode mode) {
#ifndef RELEASE
...
template <typename T>
inline void SlideLockedPartitionDown(TEN &AT, const TEN &A0, const TEN &A1,
                                     TEN &AB, const TEN &A2, Mode mode) {
#ifndef RELEASE
...
template <typename T>
inline void SlideLockedPartitionDown(DTEN &AT, const DTEN &A0, const DTEN &A1,
                                     DTEN &AB, const DTEN &A2, Mode mode) {
#ifndef RELEASE
